...
<head>
	...
	<title>Eakins Press Foundation :: Leslie Katz &amp; appreciations</title>
	<!-- meta data -->
				...
				<div class="container">
					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 sticky-box">
							...
							<ul>
								<li><a href="about_the_press.cfm">Overview</a></li>
								<li><a href="history_of_the_press.cfm">History of the Press</a></li>
								<li class="active"><a href="leslie_katz_and_appreciations.cfm">Leslie Katz &amp; <br>Appreciations</a></li>
							</ul>
						</nav>
					</div>
