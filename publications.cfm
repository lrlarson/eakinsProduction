...
<head>
	...
	<title>Eakins Press Foundation :: Publications</title>
	<!-- meta data -->
	...
	<![endif]-->
      ...
      <meta property="og:url" content="https://wwww.eakinspress.com/publications.cfm"/>
		...
		<main id="main" role="main">
				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 sticky-box">
						<nav class="left-nav fixed">
							<ul>
								...
								<li class="photoNav"><a href="#" onclick="getBooks(2);">Photography</a></li>
								<li>
								<input type="text" width="25px" id="searchText" placeholder="Search Books">
								<button name="search" id="search" title="search" onclick="startSearch()" class="apply">Search</button>
								<button name="clearSearch" id="clearSearch" title="Reset" onclick="clearSearchButton()" class="reset">Reset</button>
								</li>
							</ul>
						</nav>
					</div>
					<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
						...
						<div class="content">
							...
							<div class="textarea"id="searchReport"> <!-- inject text here ---></div>
								<script id="search-template" type="x-handlebars-template">
								<p>{{makeNo number}} book{{makePlural number}} found in a search for <span class="accent">{{stringTarget}}</span></p>
			...
			<section class="box-area">
				<div class="container">
					...
					<div class="col-lg-9 col-lg-offset-3 col-md-9 col-md-offset-3 col-sm-9 col-sm-offset-3 col-xs-12"id="booksDisplay"><!-- insert content here ---></div>
						<script id="books-template" type="x-handlebars-template">
						{{#each data}}	
						<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 col">
							<div class="box">
								<a href="book.cfm?slug={{slug}}"><img src="images/portraits/portraitsCompressed/{{filename}}" alt="Image Description">
									<header class="head">
										<h1>{{{title}}}</h1>
										<h2>{{{showEllipse credits}}}</h2>
									</header>
								</a>
							</div>
						</div>
