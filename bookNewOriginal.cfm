							...
							<div class="isotope-filter">
								<div class="nav-holder filters">
									<ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
										<li class="active"><a href="#" class="show-all">All</a></li>
										<li><a href="#" rel='review'>Reviews</a></li>
										<li><a href="#" rel='event'>Events</a></li>
										<li><a href="#" rel='resource'>Resources</a></li>
									</ul>
								</div>
									<!-- box-holder- -->
									<div class="sort-boxes">
										<div class="box-holder sort-boxes-holder">
											<!-- box-->
											<a href="#">
												<article class="box large sort-box" rel='resource'>
													<span class="category">Online Exhibition</span>
													<span class="title">Augustus Saint-Gaudens' Shaw Memorial</span>
													<span class="source">National Gallery of Art</span>	
												</article>
											</a>
											<!-- box-->
											<a href="#">
												<article class="box large sort-box" rel='resource'>
													...
													<span class="title">Public Sculpture in New York City: Lesser Art and Lost Ideals</span>
													<span class="source">The New York Times &#8212; Hilton Kramer</span>
													<span class="date">June 30, 1974</span>	
												</article>
											</a>
											<!-- box-->
											<a href="#">
												<article class="box large sort-box" rel='resource'>
													...
													<span class="title">The Shaw Memorial Project</span>
													<span class="source">National Gallery of Art</span>	
												</article>
											</a>
											<!-- box-->
											<a href="#">
												<article class="box large sort-box" rel='resource'>
													<span class="category">Resource</span>
													<span class="title">Saint-Gaudens National Historic Site</span>
													<span class="source">National Park Service, U.S. Department of the Interior</span>	
												</article>
											</a>
											<!-- box-->
											<a href="#">
												<article class="box large sort-box" rel='event'>
													<span class="category">Exhibition</span>
													<span class="title">Augustus Saint-Gaudens' Memorial to Robert Gould Shaw and the Massachusetts Fifty-fourth Regiment</span>
													<span class="source">National Gallery of Art</span>
													<span class="date">September 21-December 14, 1997</span>	
												</article>
											</a>
											<!-- box-->
											<a href="#">
												<article class="box large sort-box" rel='event'>
													<span class="category">Exhibition</span>
													<span class="title">Richard Benson Palladium Prints</span>
													<span class="source">Washburn Gallery, New York, NY</span>
													<span class="date">October 6-October 30, 1976</span>	
												</article>
											</a>
										</div>
									</div>
