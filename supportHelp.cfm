					...
					<div class="col-lg-9">
								<div class="content">
									...
									<div class="alignright">
										<img src="images/support_the_press.jpg" alt="Leslie George Katz" style="width: 300px !important;"><br>
										<a href="#" class="button" style="width:300px !important; text-align: center;">Support the Press</a><br>
									</div>
									...
									<p>All gifts are fully tax-deductible. <a href="#">Click here to make a tax-deductible donation.</a></p>
			...
			<div class="container">
				...
				<div class="footer-content">
					...
					<ul class="social-networks">
						<li><a href="https://www.facebook.com/eakinspress"><i class="icon-facebook"></i></a></li>
						<li><a href="https://twitter.com/eakinspress"><i class="icon-twitter"></i></a></li>
						<li><a href="http://instagram.com/eakinspress"><i class="icon-instragram"></i></a></li>
					</ul>
				</div>
